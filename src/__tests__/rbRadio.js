  ...
  const wrapper = shallow(
    <Reform>
      <form onSubmit={function() {}}>
        <Radio name={name} value="opt1" checked={false} onChange={onChange} required />
        <Radio name={name} value="opt2" checked={false} onChange={onChange} required />
        <Radio name={name} value="opt3" checked={false} onChange={onChange} required />
        <Radio name={name} value="opt4" checked={false} onChange={onChange} required />
      </form>
    </Reform>
  );
...
describe('React-Bootstrap: Radio', () => {
  describe('with initial value: "" ', () => {
    ...
    it('should set the correct value when clicking', () => {
      wrapper.find('[value="opt3"]').simulate('change', { target: {value: 'opt3'}});
  ...
  describe('with initial value: "opt3" (middle radio)', () => {
      ...
      const wrapper = shallow(
        <Reform>
          <form onSubmit={function() {}}>
            <Radio name={name} value="opt1" checked={false} onChange={onChange} required />
            <Radio name={name} value="opt2" checked={false} onChange={onChange} required />
            <Radio name={name} value="opt3" checked={true} onChange={onChange} required />
            <Radio name={name} value="opt4" checked={false} onChange={onChange} required />
          </form>
        </Reform>
      );
    ...
    it('should set the correct value when clicking', () => {
      wrapper.find('[value="opt2"]').simulate('change', { target: {value: 'opt2'}});
  ...
  describe('with initial value: "opt1" (first radio)', () => {
    function render() {
      ...
      const wrapper = shallow(
        <Reform>
          <form onSubmit={function() {}}>
            <Radio name={name} value="opt1" checked={true} onChange={onChange} required />
            <Radio name={name} value="opt2" checked={false} onChange={onChange} required />
            <Radio name={name} value="opt3" checked={false} onChange={onChange} required />
            <Radio name={name} value="opt4" checked={false} onChange={onChange} required />
          </form>
      ...
      const wrapper = shallow(
        <Reform>
          <form onSubmit={function() {}}>
            ...
            <Radio name={name} value="opt2" checked={false} onChange={onChange} required />
            <Radio name={name} value="opt3" checked={false} onChange={onChange} required />
            <Radio name={name} value="opt4" checked={true} onChange={onChange} required />
          </form>
        </Reform>
      );
