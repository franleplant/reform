...
describe("validateField", () => {
  ...
  it(`should work when valid`, () => {
    const instance = createInstance();
    const isValid = reactHelpers.validateField.call(
      instance,
      "email",
      "a@b.com"
    );
  ...
  it(`should throw error on __DEV__ (implicit) and malformed instnace`, () => {
    const instance = {};
    expect(() =>
      reactHelpers.validateField.call(instance, "email", "a")
    ).toThrow();
  });
  ...
  it(`should throw error on __DEV__ (implicit) and field does not exist`, () => {
    const instance = createInstance();
    expect(() =>
      reactHelpers.validateField.call(instance, "doesnotexist", "a")
    ).toThrow();
  });
});
...
describe("validateFieldFromState", () => {
  ...
  it(`should throw error on __DEV__ (implicit) and malformed instnace`, () => {
    const instance = {};
    expect(() =>
      reactHelpers.validateFieldFromState.call(instance, "email")
    ).toThrow();
  });
  ...
  it(`should throw error on __DEV__ (implicit) and field does not exist`, () => {
    const instance = createInstance();
    expect(() =>
      reactHelpers.validateFieldFromState.call(instance, "doesnotexist")
    ).toThrow();
  });
});
...
describe("validateForm", () => {
  it(`should work when invalid`, () => {
    const instance = createInstance();
    const isValid = reactHelpers.validateForm.call(instance, {
      email: "",
      password: "",
    });
    expect(isValid).toBe(false);
    expect(instance.newState.errors).toEqual({
  ...
  it(`should throw error on __DEV__ (implicit) and malformed instnace`, () => {
    const instance = {};
    expect(() =>
      reactHelpers.validateForm.call(instance, { email: "", password: "" })
    ).toThrow();
  });
});
...
describe("fieldIsValid", () => {
  ...
  it(`should throw error on __DEV__ (implicit) and field does not exist`, () => {
    const instance = createInstance();
    expect(() =>
      reactHelpers.fieldIsValid.call(instance, "doesnotexist", "a")
    ).toThrow();
  });
});
...
describe("fieldIfError", () => {
  it(`should work positive case`, () => {
    ...
    const requiredInvalid = reactHelpers.fieldIfError.call(
      instance,
      "email",
      "required"
    );
  ...
  it(`should throw error on __DEV__ (implicit) and malformed instance`, () => {
    const instance = {};
    expect(() =>
      reactHelpers.fieldIfError.call(instance, "email", "required")
    ).toThrow();
  });
  ...
  it(`should throw error on __DEV__ (implicit) and field does not exist`, () => {
    const instance = createInstance();
    expect(() =>
      reactHelpers.fieldIfError.call(instance, "doesnotexist", "a")
    ).toThrow();
  });
});
...
describe("fieldErrors", () => {
  it(`should work when all rules are invalid`, () => {
    ...
    expect(result).toEqual([
      ["required", true],
      ["minLength", instance.validationRules.password.minLength],
    ]);
  });
  ...
  it(`should throw error on __DEV__ (implicit) and field does not exist`, () => {
    const instance = createInstance();
    expect(() =>
      reactHelpers.fieldErrors.call(instance, "doesnotexist")
    ).toThrow();
  });
});
...
describe("mapFieldErrors", () => {
  it(`should work when all rules are invalid`, () => {
    ...
    expect(result).toEqual([
      instance.validationMessages.required(),
      instance.validationMessages.minLength(),
    ]);
  });
